<div class="panel-body">
  ...
  <li role="presentation" class="">
    <a href="#tabs-demo4-area99" role="tab" id="tabs-demo4-99" data-toggle="tab" aria-expanded="false">Lulus</a>
  </li>
	</ul>
	<div id="tabsDemo4Content" class="tab-content tab-content-v3">
		<div role="tabpanel" class="tab-pane fade active in" id="tabs-demo4-area1" aria-labelledby="tabs-demo4-area1"><br>
			...
			<div class="col-sm-4" style="left: 0px;">
				...
				<div class="form-group">
					...
					<a href="#" onclick="foto('<?php echo $lamaran->ktp ;?>')" class="btn btn-danger">KTP</a>
				<?php } ?>
				</div>
									  ...
									  foreach ($res as $key => $value0) {
									    if ($value0 == $key0->id_jabatan) {
												...
												foreach ($res1 as $keyting => $valueting) {
													...
													<?php $lulus = $lamaran->level;
													$lulus1 = substr($lulus,1);
													if ($max->ke == $lulus1) { ?>
														<input type="radio" name="rate" value="Lulus" required> Lulus
													<?php }
												 } } }
											}
										}
      ...
      <div role="tabpanel" class="tab-pane fade" id="tabs-demo4-area99" aria-labelledby="tabs-demo4-area99"><br>
				<?php $no = 1; foreach ($rate as $key) {
					$s = substr($key->rate,1);
					if ($key->rate == "Lulus") { ?>
				<div class="form-group">
				...
				<?php } else { ?>
				    ...
				    <div class="col-md-9">
							...
							<input type="radio" <?php $a = substr($key->rate,0,1); if ($a == "P") echo 'checked = "checked"';?> name="rate<?php echo $key->id_komentar;?>" value="P" disabled> Pending
							<input type="radio" <?php $a = substr($key->rate,0,1); if ($a == "N") echo 'checked = "checked"';?> name="rate<?php echo $key->id_komentar;?>" value="N" disabled> No
              <input type="radio" <?php if ($key->rate == "Lulus") echo 'checked = "checked"';?> name="rate<?php echo $key->id_komentar;?>" value="Lulus" disabled> Lulus
						</div>
				  </div>
				<?php }
			 	$no++; } } ?>
