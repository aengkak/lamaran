...
<div id="content">
   <div class="panel box-shadow-none content-header">
      <div class="panel-body">
         <div class="col-md-12">
            <h3 class="animated fadeInLeft">Telah Diterima
            </h3>
                              ...
                              <td>
                                <div class="btn-group" role="group">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo base_url();?>print/<?php echo $p->id_lamaran;?>" target="_blank">Print</span></a></li>
                                    <?php foreach ($res as $keyres => $value):
                                      if ($value == $key->id_jabatan) {?>
                                    <li><a onclick="edit(<?php echo $p->id_lamaran;?>)" href="#">Hapus</a></li>
                                    <?php } endforeach; ?>
                                  </ul>
                                </div>
                              <!--  <?php foreach ($res as $keyres => $value):
                                  if ($value == $key->id_jabatan) {?>
                                    <a href="#" class="btn btn-warning fa fa-edit" onclick="edit(<?php echo $p->id_lamaran;?>)">
                                    </a>
                                <?php } endforeach; ?>
                                 <a href="#" class="btn btn-info fa fa-comments" onclick="view(<?php echo $p->id_lamaran;?>)">
                                 </a>
                                 <a href="<?php echo base_url();?>print/<?php echo $p->id_lamaran;?>" target="_blank" class="btn btn-default fa fa-eye">
                                 </a> -->
                              </td>
                           </tr>
                           <?php $no++;
...
<script type="text/javascript">
   function view(id)
   {
     ...
     $("#modalbody").load("<?php echo base_url();?>rate2/"+id,function(data){
       $("#modalbody").html(data);
     }
     );
