...
<html lang="en">
   ...
   <body id="mimin" class="dashboard greybg">
                                 ...
                                 <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-9" style="padding-top: 7px;">
                                          ...
                                          <input type="radio" id="wa3" name="wa" value="T" required> Tidak Menggunakan WhatsApp
                                       </div>
                                    </div>
                                    <div id="nomerwa"></div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-9">
                                          <input name="email" id="email" placeholder="email@email.com" class="col-md-12" type="email" required>
                                       </div>
                                    </div>
                                 </div>
                              </div>
      ...
      <script>
         function save3()
         { if ($("#wa1:checked,#wa2:checked,#wa3:checked").length == 1)
         {
         	if($('#nama').val() == ''){
