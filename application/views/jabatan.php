            ...
            <div id="content">
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><button class="btn btn-primary fa fa-plus" onclick="add()"></button></div>
                    <div class="panel-body">
					  ...
					  <?php $no = 1; foreach ($jabatan as $j) :?>
                        <tr>
                          ...
                          <td><button class="btn btn-warning fa fa-edit" onclick="edit(<?php echo $j->id;?>)"></button>
							  <button class="btn btn-danger fa fa-exchange" onclick="change(<?php echo $j->id;?>)"> </button>
						  </td>
                        </tr>
                        <?php $no++; endforeach;?>
                      </tbody>
...
<script type="text/javascript">
    ...
    function edit(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('jedit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
