...
<div id="content">
   <div class="panel box-shadow-none content-header">
      <div class="panel-body">
         <div class="col-md-12">
            <h3 class="animated fadeInLeft">Data yang telah di hapus
            </h3>
                              ...
                              <td>
                                <div class="btn-group" role="group">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a onclick="reject(<?php echo $p->id_lamaran;?>)" href="#">Batal Hapus</a></li>
                                    <?php } endforeach; ?>
                                  </ul>
                                </div>
                              </td>
...
<script type="text/javascript">
   ...
   function reject(id)
   {
     if(confirm('Yakin batal hapus?'))
     {
       // ajax delete data from database
       $.ajax({
         url : "<?php echo site_url('ldelete1')?>/"+id,
         type: "POST",
         dataType: "JSON",
         success: function(data)
         {
